...
The Network State is a concept regarding the creation of a new country, first on the cloud and then on the physical world. In essence, a group of people from disparate geographic first organize in the cloud (as they already do), then build a community, they pool assets and finally buy land.

Because of the rise of The Sovereign Individual, the financial power of this people can be so important, that a nation state will be willing to bargain with them for land.
